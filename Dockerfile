...
RUN apk add --no-cache --virtual .tools m4 jo bash curl unzip jsonnet openssl uuidgen aws-cli iso-codes imagemagick imagemagick-jxl imagemagick-heic imagemagick-webp fontconfig ttf-dejavu ttf-liberation apprise &&\
